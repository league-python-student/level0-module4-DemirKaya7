...
if __name__ == '__main__':
    ...
    while money_in_dollars > 0:
        ...
        if money_spent == 0:
            messagebox.showinfo(title = "Money left", message = "You still have " + str(money_in_dollars) + "dollars")
            break
    ...
    #  congratulates the user because they maximized their money.
        if money_in_dollars == 0:
            messagebox.showinfo(title = "Congratulations", message = "You have maximixed your money")

    # TODO) If there is a negative amount of money, tell the user they
    #  overspent!
        if money_in_dollars < 0:
            messagebox.showinfo(title = "Oh no!", message = "You've overspent!")
